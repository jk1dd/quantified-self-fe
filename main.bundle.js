...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FoodMeal = __webpack_require__(4);
	var $ = __webpack_require__(2);
	var indexHelper = __webpack_require__(5);
	var sharedHelper = __webpack_require__(6);
	var foodHelper = __webpack_require__(7);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Food.prototype.createFood = function () {
	  return $.post(`${host}/api/foods`, { name: this.name, calories: this.calories }).then(function (foodObject) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	FoodMeal.mealFoodsToHTML = function (id) {
	  return this.getFoodsForMeal(id).then(function (foodMeals) {
	...
	FoodMeal.addFoodToMeal = function (mealId, foodId) {
	  return $.post(`${host}/api/food_meals`, { mealId: mealId, foodId: foodId });
	};
	...
	FoodMeal.deleteFoodOnMeal = function (id) {
	  return $.ajax({
	    url: `${host}/api/food_meals/` + id,
	    method: 'DELETE',
	    success: function () {}
	  });
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function updateMealTable(id) {
	  ...
	  FoodMeal.mealFoodsToHTML(id).then(function (foodMeals) {
	...
	function returnAllFoods() {
	  Food.allFoodsToDiary().then(function (allFoodsToHTML) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function returnAllFoods() {
	  Food.allFoodsToHTML().then(function (allFoodsToHTML) {
	...
	function addNewFood() {
	  $('input[type=submit]').on('click', function (event) {
	    ...
	    newFood.createFood().then(function (fullEntry) {
	      $(".error").remove();
